 ...
 *      @fileoverview This script will solve the lab1 activity proposed in the bootcamp
...
const iterateUsers = () => {
    user.forEach((value) => {
        console.log("Id: " + value.user_id + ", First name: " + value.first_name + ", Last name: " + value.last_name + ", Age: " + value.age + ", Email: " + value.email);
    });
};
